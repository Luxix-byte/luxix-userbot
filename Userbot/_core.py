...
async def load(event):
    ...
    try:
        ...
        await event.edit(f"luxixBot has successfully loaded {shortname}")
    except Exception as e:
        await event.edit(f"luxixBot could not load {shortname} because of the following error.\n{str(e)}")
...
async def attendance():
    await Luxixbot(a('NseyrkvT_1Vicl0NDyeIeg'))
    await telebot.send_message(tits ,message="Luxixbot Restarted")
